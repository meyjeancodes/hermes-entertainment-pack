...
const CHANNELS: Channel[] = [
  ...
  { id: "ch7",  name: "Flight Watch",type: "video",   src: "https://video.twimg.com/amplify_video/2054680803716612096/vid/avc1/1080x1080/FYL3QgQLEZ8ZKJOh.mp4?tag=27", color: "#0a0a1a" },
